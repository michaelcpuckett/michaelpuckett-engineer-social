...
const ImageSelectorTemplate_1 = require("./ImageSelectorTemplate");
                ...
                react_1.default.createElement("main", null,
                    ...
                    react_1.default.createElement("div", { className: "container" },
                        react_1.default.createElement("div", null,
                            ...
                            react_1.default.createElement(UploadMediaForm, { actor: actor }),
                    ...
                    react_1.default.createElement(ImageSelectorTemplate_1.ImageSelectorTemplate, null)))));
}
...
function CreateNoteForm({ actor }) {
    return (react_1.default.createElement("div", { className: "feed" },
        ...
        react_1.default.createElement("form", { id: "CreateNoteForm", action: (0, activitypub_core_utilities_1.getId)(actor.outbox).toString(), noValidate: true },
            ...
            react_1.default.createElement("label", null,
                react_1.default.createElement("span", null, "Image"),
                react_1.default.createElement("image-selector", { "data-user-id": (0, activitypub_core_utilities_1.getId)(actor).toString() },
                    react_1.default.createElement("input", { type: "hidden", name: "attachment", slot: "input" }))),
...
function UploadMediaForm({ actor }) {
    return react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("form", { action: actor.endpoints.uploadMedia.toString(), id: "UploadMediaForm" },
            react_1.default.createElement("input", { type: "file", name: "file" }),
            react_1.default.createElement("input", { type: "hidden", name: "object", value: JSON.stringify({
                    "type": "Image",
                }) }),
            react_1.default.createElement("button", { type: "submit" }, "Upload")),
        react_1.default.createElement("script", { type: "module", src: "/UploadMediaForm.js" }));
}

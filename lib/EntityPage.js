...
function Entity({ headingLevel, entity, user }) {
    for (const type of Object.values(activitypub_core_types_1.AP.ActivityTypes)) {
        if (entity.type === type || (Array.isArray(entity.type) &&
    ...
    if (entity.type === activitypub_core_types_1.AP.CollectionTypes.COLLECTION || (Array.isArray(entity.type) && entity.type.includes(activitypub_core_types_1.AP.CollectionTypes.COLLECTION))) {
        return react_1.default.createElement(CollectionEntity, { headingLevel: headingLevel, collection: entity, user: user });
    }
    if (entity.type === activitypub_core_types_1.AP.CollectionTypes.ORDERED_COLLECTION || (Array.isArray(entity.type) && entity.type.includes(activitypub_core_types_1.AP.CollectionTypes.ORDERED_COLLECTION))) {
        return react_1.default.createElement(OrderedCollectionEntity, { headingLevel: headingLevel, collection: entity, user: user });
    }
    if (entity.type === activitypub_core_types_1.AP.ExtendedObjectTypes.NOTE || (Array.isArray(entity.type) && entity.type.includes(activitypub_core_types_1.AP.ExtendedObjectTypes.NOTE))) {
